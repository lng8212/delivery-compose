package com.longkd.presentation.theme
...
val WeightPerUnit = Color(0XFF06BE77)
val SelectedViolet = Color(0XFF7203FF)
val CheckedSwitchBackground = Color(0XFFE2CBFF)